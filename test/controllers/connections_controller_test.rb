...
class ConnectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post connections_url, params: { connection: { component: @connection.component, component_id: @connection.component_id, identifier: @connection.identifier } }
    end
  ...
  test "should update connection" do
    patch connection_url(@connection), params: { connection: { component: @connection.component, component_id: @connection.component_id, identifier: @connection.identifier } }
