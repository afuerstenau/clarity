...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { name: @component.name, notes: @component.notes, repo: @component.repo } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { name: @component.name, notes: @component.notes, repo: @component.repo } }
