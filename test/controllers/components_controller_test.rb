...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { location: @component.location, name: @component.name, notes: @component.notes, repo: @component.repo, service_id: @component.service_id } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { location: @component.location, name: @component.name, notes: @component.notes, repo: @component.repo, service_id: @component.service_id } }
